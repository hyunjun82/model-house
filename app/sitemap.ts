...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // 부동산 계산기 섹션
  const CALC = ["", "acquisition-tax", "transfer-tax", "property-holding-tax", "gift-tax", "inheritance-tax", "dsr", "dti", "ltv", "jeonse-monthly", "jeonse-loan", "mortgage-loan", "interim-loan", "broker-fee", "registration-cost", "stamp-tax", "prepayment-fee", "area"];
  for (const c of CALC) {
