...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // 부동산 계산기 섹션
  const CALC = ["", "acquisition-tax", "transfer-tax", "property-holding-tax", "gift-tax", "dsr", "jeonse-monthly", "mortgage-loan", "broker-fee", "registration-cost", "stamp-tax", "prepayment-fee"];
  for (const c of CALC) {
