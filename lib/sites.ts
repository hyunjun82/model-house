...
export const sites: Record<string, Site> = {
  "cheongju-platinum": {
    ...
    keywords: [
      "청주 센트럴 더 플래티넘", "센트럴 더 플래티넘 청주", "가경 센트럴 더 플래티넘", "가경동 센트럴 더 플래티넘",
      "청주 센트럴 더 플래티넘 견본주택", "센트럴 더 플래티넘 모델하우스", "청주 가경동 분양", "가경동 모델하우스",
      "청주 모델하우스", "청주 민간임대 아파트", "청주 가경동 아파트", "청주 신축 아파트", "청주 분양",
      "청주 49층 아파트", "센트럴 더 플래티넘 분양가", "CTX 청주", "청주 잔여세대", "청주 분양 일정",
    ],
