...
export const sites: Record<string, Site> = {
  "cheongju-platinum": {
    ...
    metaDescription:
      "청주 가경동 센트럴 더 플래티넘 ☎1599-9433 | CTX 초역세권·SK하이닉스 20조 호재 | 전용 59·84㎡, 사업계획승인 완료 | 모델하우스·평면도·분양가·잔여세대·방문예약 안내.",
    keywords: [
      "청주 센트럴 더 플래티넘", "센트럴 더 플래티넘 청주", "가경 센트럴 더 플래티넘",
      "청주 가경동 분양", "가경동 모델하우스", "청주 모델하우스", "청주 민간임대 아파트",
      "청주 분양", "청주 49층 아파트", "센트럴 더 플래티넘 분양가", "CTX 청주", "청주 잔여세대",
    ],
