...
export default function SiteView({ site }: { site: Site }) {
  ...
  return (
    <>
      <nav id="nav"><div className="container row">
        <div className="brand">{site.brand}<small>{site.brandSub}</small></div>
        <div className="links">
          <a href="#news">보도자료</a><a href="#dev">개발호재</a><a href="#location">입지</a><a href="#plans">평형</a>
          <a href="#reserve" className="navcta">방문상담 예약</a>
        </div>
      </div></nav>
      ...
      <section className="sec alt" id="dev"><div className="container">
      ...
      <section className="sec" id="location"><div className="container">
